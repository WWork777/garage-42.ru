...
const allServices = [
  ...
  {
    title: "Ремонт и покраска литых дисков",
    time: "1-3 часа",
  ...
  },
  {
    title: "Правка дисков",
    time: "1-3 часа",
    image: "/images/services/Правка дисков.jpg",
    price: "от 1 500",
    garanty: "6 мес",
    fullDescription:
      "Восстановление геометрии стальных и литых дисков после ударов и наездов на препятствия. Холодная правка без нагрева металла, сохраняющая структуру сплава. Устранение радиального и осевого биения. Контроль на балансировочном стенде до и после правки. Полное восстановление круглости диска.",
  },
  {
  ...
  },
  {
    ...
    garanty: "6 мес",
    fullDescription:
      "Установка дополнительного оборудования любой сложности: парктроники, камеры заднего вида, сигнализации, иммобилайзеры, подогревы сидений и зеркал, автономные отопители, фаркопы, шумоизоляция. Штатная интеграция в электросистему автомобиля, аккуратный монтаж, прокладка проводки в штатные жгуты.",
  },
  {
    title: "Автосервис",
    time: "от 1 часа",
    ...
    garanty: "6 мес",
    fullDescription:
      "Комплексное обслуживание автомобилей всех марок. Полный спектр ремонтных работ от планового ТО до сложного кузовного ремонта. Собственный склад запчастей, работа с заказ-нарядами, фотоотчет для клиента. Прозрачное ценообразование, поэтапная оплата. Индивидуальный подход к каждому автомобилю.",
  },
  {
  ...
  },
  {
    ...
    garanty: "1 мес",
    fullDescription:
      "Полная компьютерная диагностика всех систем автомобиля профессиональным сканером. Считывание и расшифровка кодов ошибок, анализ данных с датчиков в реальном времени. Проверка двигателя, АКПП, ABS, SRS, климат-контроля. Эндоскопия цилиндров, замер компрессии, давления масла и топлива. Развернутая диагностическая карта с рекомендациями.",
  },
  {
